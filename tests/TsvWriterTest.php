...
use Luchaninov\CsvWriter\TsvWriter;
use PHPUnit\Framework\TestCase;

class TsvWriterTest extends TestCase
{
    public function testGenerate(): void
    {
        ...
        self::assertSame($expected, (new TsvWriter())->generate($items));
    }
    ...
    public function testGenerateWithNonStringsMultiline(): void
    {
        $items = [
            ['k1' => new \DateTime('2000-01-02 03:04:05'), 'k2' => ['a', 'b'], 'k3' => ['a' => 'b', 'c' => 'd']],
            ['k1' => 1, 'k2' => -2.34, 'k3' => "test\ttest\rtest\ntest"],
